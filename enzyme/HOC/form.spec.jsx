...
// reduxForm({...options})(MyForm) => so reduxForm is an HOC function, should be mocked as a (configuration)=>(component)=>component
...
jest.mock('redux-form', () => ({
  ...
  reduxForm: (configuration) => (wrapped_component) => wrapped_component, // just pass through component without decorating it; reduxForm is a HOC so it should be mocked this way;
}))
